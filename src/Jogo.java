...
public class Jogo {
     ...
     * 
     * @param valorArma O número em formato String da arma representada em exibirMensagemArma();
    ...
    /**
     * Contextualiza o momento final do jogo, indicando sua vitória ou derrota baseada
     * em sua vida.
     * 
     ...
     * 
     * @return A mensagem impressa na interface a partir da investtigação de determinadas salas.
     */
     ...
     * @return A mensagem impressa na interface a partir de suas interações no porão.
     */
